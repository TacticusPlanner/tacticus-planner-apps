...
Every primary tab other than Raids SHALL render the shared "Under Construction" placeholder rather than an error, a blank page, or partial functionality.

#### Scenario: Opening a non-Raids tab

- **WHEN** the user opens Shops, Onslaught, Salvage Run, Arena, or Guild Raids
