...
function asSingleRow(id: string, data: unknown): Record<string, unknown>[] {
...
> = {
  ...
  shops: asArray,
  "raid-bosses": (data) => asSingleRow("raid-bosses", data),
  "guild-raid-meta": (data) => asSingleRow("guild-raid-meta", data),
}
